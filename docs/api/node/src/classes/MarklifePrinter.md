...
[marklife](../../../README.md) / [node/src](../README.md) / MarklifePrinter

# Class: MarklifePrinter
...
> **new MarklifePrinter**(`device`, `transport`, `transportType`, `options?`): `MarklifePrinter`
...
[`MarklifePrinterOptions`](../interfaces/MarklifePrinterOptions.md) = `{}`
...
> **getStatus**(): `Promise`\<[`MarklifeStatus`](../interfaces/MarklifeStatus.md)\>
...
`Promise`\<[`MarklifeStatus`](../interfaces/MarklifeStatus.md)\>
